...
async function handler(req, res) {
    try {
        switch(req.method){
            case 'GET':
                const articles = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$api$5d$__$28$ecmascript$29$__["prisma"].article.findMany();
                return res.status(200).json(articles);
            case 'POST':
                const newArticle = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$api$5d$__$28$ecmascript$29$__["prisma"].article.create({
                    data: req.body
                });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3c2d93._.js.map